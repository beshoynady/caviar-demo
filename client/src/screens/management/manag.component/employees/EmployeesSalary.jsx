                    ...
                    <form onSubmit={addSalaryMovement}>
                      ...
                      <div className="modal-body">
                        <div className="form-group">
                          <label>الاسم</label>
                          <select form="carform" required  onChange={(e) =>{console.log(listofemployee.find(em=>em._id == e.target.value).fullname) ;setEmployeeName(listofemployee.find(em=>em._id == e.target.value).fullname);setEmployeeId(e.target.value)}}>
                            <option>اختر</option>
