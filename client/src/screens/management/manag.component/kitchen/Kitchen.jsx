...
const Kitchen = () => {
  ...
  const waitingTime = (t) => {
    ...
    const m = Math.floor(waitingTime / (1000 * 60)); // Calculate minutes
                    ...
                    <div className="card text-white bg-success" style={{ width: "265px" }}>
                      ...
                      <div className="card-footer text-center">
                        {order.status === 'Preparing' ?
                          <button className="btn btn-danger btn-lg" style={{ width: "100%" }} onClick={() => { orderDone(order._id); updatecountofsales(order._id) }}>تم التنفيذ</button>
