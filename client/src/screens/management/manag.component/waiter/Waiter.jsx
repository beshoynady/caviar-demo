                  ...
                  <div className="card text-white bg-success" style={{ width: "265px" }}>
                    ...
                    <div className="card-footer text-center">
                      {order.status === 'Prepared' ?
                        ...
                        : <button className="btn btn-primary btn-lg" style={{ width: "100%" }} onClick={() => helpDone(order._id)}>تم</button>
                      }
                    </div>
                  </div>
                )
                    ...
                    <div className="card text-white bg-success" style={{ width: "265px" }}>
                      ...
                      <div className="card-footer text-center">
                        {order.status === 'Prepared' ?
                          ...
                          : <button className="btn btn-primary btn-lg" style={{ width: "100%" }} onClick={() =>{ updateOrderDelivered(order._id)}}>تم التسليم</button>
                        }
                      </div>
                    </div>
